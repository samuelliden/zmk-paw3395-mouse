...
#define K_SYSCALL_DRIVER_BEHAVIOR(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, behavior, BEHAVIOR)

#define K_SYSCALL_DRIVER_EXT_POWER_API(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, ext_power_api, EXT_POWER_API)

#define K_SYSCALL_DRIVER_ZMK_INPUT_PROCESSOR(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, zmk_input_processor, ZMK_INPUT_PROCESSOR)
