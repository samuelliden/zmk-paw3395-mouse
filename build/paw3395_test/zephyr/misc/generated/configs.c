...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_PAIRED, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PAW3395_NEOPIXEL_POWER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BATTERY_VOLTAGE_DIVIDER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_PAW3395_INIT_PRIORITY, 90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PAW3395_INIT_POWER_UP_EXTRA_DELAY_MS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PAW3395_REPORT_INTERVAL_MIN, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_PAW3395_DRIVER_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_PAW3395_MOUSE_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BATTERY_VOLTAGE_DIVIDER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_PAW3395, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_COUNT_EXTRA, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_FRAG_COUNT, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LLCP_CONN, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LLCP_LOCAL_PROC_CTX_BUF_NUM, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LLCP_REMOTE_PROC_CTX_BUF_NUM, 5);
